...
const {
  getAllQRCodes, createQRCode,
  generateQRCodeWithUserInfo, generateWhatsAppQRCode,
  getQRCodeById, getQRCodeByCode, deleteQRCode, serveQRCodeImage,
  incrementShareCount, incrementScanCount,
  getUserOwnQRCodes, getQRAnalytics,
  getQRPerformance, getQRCodesWithAnalytics,
  scanQRCode, shareQRCode
} = require('./controller');

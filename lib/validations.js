...
const userRegistrationSchema = z.object({
  ...
  businessPublicSlug: z.string().regex(/^[a-z0-9]{7}$/, 'Invalid businessPublicSlug').optional(),
...
/** Customer portal login: Israeli phone only (unique business match on server) */
...
// Payment validation schemas (Note: Payment model removed - using PaymentWebhook instead)
...
module.exports = {
  ...
  // orderCreateSchema, // Removed - Order model no longer exists
  // orderUpdateSchema, // Removed - Order model no longer exists
  // paymentCreateSchema, // Removed - Payment model no longer exists (using PaymentWebhook instead)
  qrCodeCreateSchema,
